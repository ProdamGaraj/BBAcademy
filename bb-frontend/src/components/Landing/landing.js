    ...
    return (<>
            <div className="block-learn-in">
                ...
                <div className="block-learn-in_right-section">
                    ...
                    <div className="block-learn-in_right-section-top-top">{translations[currentLang].learnWithBBAcademy}</div>
                    <div className="block-learn-in_right-section-top-bot">{translations[currentLang].improveYourProfessionalCapital}</div>
                    </div>
                    ...
                    <div className="popular-bot">
                        <div className="popular-bot-block">
                            ...
                            <div className="popular-bot-block-deco-1">
                                <div className="popular-bot-block-deco-title">{translations[currentLang].infestionForBeginners}</div>
                            </div>
                        </div>
                        <div className="popular-bot-block">
                            <img className="popular-bot-block" src="/img/Shared/photo.png"/>
