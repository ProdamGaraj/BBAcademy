...
Answer Answer = new Answer("Sun is yellow", false,110,new Question());
await ar.Add(Answer);
...
Certificate Certificate = new Certificate(1,"Some media templatepath",2, new List<Course>());
...
Course Course = new Course("20 minutes", "course for banking",CourseType.Passed,null, new Exam());
